...
public final class FileWriter {
	...
	// public static void write2Excel(String fileName, String[] titles,
	...
	public static void write2Txt(String fileName, String[] titles, String[][] contents, Charset... charset) throws IOException {
		try (FileOutputStream fos = new FileOutputStream(fileName);
				OutputStreamWriter osw = new OutputStreamWriter(fos, charset.length == 0 ? Charset.UTF8.VALUE : charset[0].VALUE);
